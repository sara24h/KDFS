...
device=${DEVICE:-0,1}  # استفاده از دو GPU (0 و 1)
...
train_batch_size=${TRAIN_BATCH_SIZE:-32}  # افزایش بچ سایز برای دو GPU (16*2)
eval_batch_size=${EVAL_BATCH_SIZE:-32}    # افزایش بچ سایز برای دو GPU (16*2)
