...
from model.student.ResNet_sparse import ResNet_50_sparse_hardfakevsreal  # Assuming this is the default model
# Import other models if available, e.g.:
# from model.student.OtherModel import OtherModel
...
class Test:
    def __init__(self, args):
        ...
        self.arch = args.arch  # Now used to select model
